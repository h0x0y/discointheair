...
class ArcballControl {
  ...
  public update(deltaTime: number, targetFrameDuration = 16): void {
    ...
    if (this.isPointerDown) {
      ...
      const ANGLE_AMPLIFICATION = 2 / timeScale;
      ...
      const INTENSITY = 0.25 * timeScale;
      quat.slerp(this.pointerRotation, this.pointerRotation, this.IDENTITY_QUAT, INTENSITY);
    ...
    const RV_INTENSITY = 0.8 * timeScale;
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], scale = 1.0, onItemClick, onActiveItemChange }) => {
      ...
      {activeItem && (
        ...
        `}
          ...
          ease-[cubic-bezier(0.34,1.56,0.64,1)]
           ...
           // Hover 特效
        hover:scale-110                                  // 放大
        hover:shadow-[0_15px_40px_rgba(34,197,94,0.4)]   // 增强绿色阴影
        hover:drop-shadow-[0_0_40px_rgba(34,197,94,0.9)] // 强烈绿光
        hover:border-green-400                           // 边框变亮
